...
enum class GeminiModel(
    ...
    FLASH_EXTENDED("Gemini 3.5 Flash", "gemini-3.5-flash", "Fast & versatile for most tasks", "Recommended"),
    FLASH_LITE("Gemini 3.5 Lite", "gemini-3.5-flash", "Lightweight, ultra-fast responses", "Fast"),
    PRO("Gemini 3.1 Pro", "gemini-3.1-pro", "Advanced reasoning, coding and analysis", "Thinking"),
    LIVE("Gemini 3.5 Live", "gemini-3.5-flash", "Real-time Live API for voice conversations", "Live")
}
